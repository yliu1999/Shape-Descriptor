...
def compute_independent_mAP(final_results, synset_names, degree_thresholds=[360], shift_thresholds=[100], iou_3d_thresholds=[0.1], iou_pose_thres=0.1, use_matches_for_pose=True, logger=None, plot_figure=True, log_dir=None):
    ...
    import pickle
    linechart_path = "/home/yliu/Desktop/project/Learning/experience/IST-Net-30/log_CAMERA/mug/data.pkl"
    ...
    iou_3d_aps[-1, :] = np.mean(iou_3d_aps[1:-1, :], axis=0)  # iou_3d_aps[1:7] object   iou_3d_aps[8] mean
...
##
    iou_dict['degree_thres_list'] = degree_thres_list
    iou_dict['pose_aps'] = pose_aps
    iou_dict['shift_thres_list'] = shift_thres_list
    # 将数值保存到.pkl文件
    with open(linechart_path, "wb") as file:
        pickle.dump(iou_dict, file)
